...
class RedirectIfNoLocale
{
    ...
    {   
        if ($request->is('livewire/*') || $request->is('api/*') || $request->is('images/*') || $request->is('storage/*') || $request->is('public/*') || $request->is('admin-panel/*') || $request->is('admin-panel') || $request->is('horizon') || $request->is('horizon/*')) {
