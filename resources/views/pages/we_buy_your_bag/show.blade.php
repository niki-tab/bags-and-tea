...
<div class="w-full relative bg-[#F6F0ED]">
    ...
    <div class="bg-[#C8928A] text-white pb-16 text-center">
        <h2 class="mx-4 relative top-12 text-center text-5xl font-regular font-['Lovera']">{{ $stringStepsTitle }}</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8 px-4 md:px-16 py-12 md:py-4 md:h-[500px] mt-0 md:mt-6">
            ...
            <div class="mt-6 text-center md:text-left mx-8 md:mx-0">
                <div class="flex items-center gap-4 mb-8 md:mb-0">
                    ...
                    <h3 class="pb-0 text-center md:text-left text-3xl md:text-4xl text-robotoCondensed font-regular md:w-2/5 mb-2">
                        {{ $stringStep1Title }}
                    </h3>
                </div>
                <p class="text-left text-[#482626] font-robotoCondensed font-regular mt-4 md:mt-[-70px] pt-0 md:pt-20">
            ...
            <div class="mt-6 text-center md:text-left mx-8 md:mx-0">
                ...
                <p class="text-left text-[#482626] font-robotoCondensed font-regular mt-3 md:mt-[-70px] pt-0 md:pt-20">
