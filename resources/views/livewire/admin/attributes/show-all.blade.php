                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($attributes as $attribute)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $attribute->parent ? $attribute->parent->getTranslation('name', 'en') : 'NULL' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button 
            ...
            @if($attributes->hasPages())
                <div class="mt-6">
                    @livewire('shared/pagination', [
                        ...
                        'totalItems' => $attributes->total(),
                        'perPage' => $attributes->perPage(),
                        'paginationClass' => 'justify-center'
                    ], key('attributes-pagination-' . $attributes->currentPage() . '-' . $attributes->total()))
                </div>
            @endif
        </div>
    </div>
