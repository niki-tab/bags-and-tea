                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select wire:model="origin_country" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <option value="ES">Algeria</option>
                            <option value="IT">Angola</option>
                            <option value="DE">Argentina</option>
                            <option value="US">Armenia</option>
                            <option value="CA">Australia</option>
                            <option value="AU">Azerbaijan</option>
                            <option value="NZ">Bahrain</option>
                            <option value="UK">Bangladesh</option>
                            <option value="IE">Belarus</option>
                            <option value="NL">Belgium</option>
                            <option value="BE">Bolivia</option>
                            <option value="CH">Bosnia and Herzegovina</option>
                            <option value="AT">Botswana</option>
                            <option value="SE">Brazil</option>
                            <option value="NO">Bulgaria</option>
                            <option value="DK">Cambodia</option>
                            <option value="FI">Cameroon</option>
                            <option value="PL">Canada</option>
                            <option value="CZ">Chile</option>
                            <option value="HU">China</option>
                            <option value="RO">Colombia</option>
                            <option value="BG">Congo</option>
                            <option value="GR">Costa Rica</option>
                            <option value="TR">Croatia</option>
                            <option value="AE">Cuba</option>
                            <option value="SA">Dominican Republic</option>
                            <option value="QA">Ecuador</option>
                            <option value="KW">Egypt</option>
                            <option value="OM">El Salvador</option>
                            <option value="AE">Equatorial Guinea</option>
                            <option value="SA">Eritrea</option>
                            <option value="QA">Estonia</option>
                            <option value="KW">Ethiopia</option>
                            <option value="OM">Fiji</option>
                            <option value="AE">Finland</option>
                            <option value="SA">France</option>
                            <option value="QA">Gabon</option>
                            <option value="KW">Georgia</option>
                            <option value="OM">Germany</option>
                            <option value="AE">Ghana</option>
                            <option value="KW">Greece</option>
                            <option value="OM">Guatemala</option>
                            <option value="AE">Honduras</option>
                            <option value="SA">Hungary</option>
                            <option value="QA">Iceland</option>
                            <option value="KW">India</option>
                            <option value="OM">Indonesia</option>
                            <option value="AE">Iran</option>
                            <option value="SA">Iraq</option>
                            <option value="OM">Israel</option>
                            <option value="AE">Italy</option>
                            <option value="SA">Jamaica</option>
                            <option value="QA">Jordan</option>
                            <option value="KW">Kazakhstan</option>
                            <option value="OM">Kenya</option>
                            <option value="AE">Kuwait</option>
                            <option value="SA">Kyrgyzstan</option>
                            <option value="QA">Laos</option>
                            <option value="KW">Latvia</option>
                            <option value="OM">Lebanon</option>
                            <option value="AE">Liberia</option>
                            <option value="SA">Libya</option>
                            <option value="QA">Lithuania</option>
                            <option value="KW">Luxembourg</option>
                            <option value="OM">Macedonia</option>
                            <option value="AE">Malaysia</option>
                            <option value="SA">Maldives</option>
                            <option value="QA">Mali</option>
                            <option value="KW">Malta</option>
                            <option value="OM">Mauritania</option>
                            <option value="AE">Mauritius</option>
                            <option value="SA">Mexico</option>
                            <option value="QA">Moldova</option>
                            <option value="KW">Monaco</option>
                            <option value="OM">Montenegro</option>
                            <option value="AE">Morocco</option>
                            <option value="SA">Mozambique</option>
                            <option value="QA">Myanmar</option>
                            <option value="KW">Namibia</option>
                            <option value="OM">Nepal</option>
                            <option value="AE">Netherlands</option>
                            <option value="SA">New Zealand</option>
                            <option value="QA">Nicaragua</option>
                            <option value="KW">Niger</option>
                            <option value="OM">Nigeria</option>
                            <option value="AE">Norway</option>
                            <option value="SA">Oman</option>
                            <option value="QA">Pakistan</option>
                            <option value="KW">Palestine</option>
                            <option value="OM">Panama</option>
                            <option value="AE">Papua New Guinea</option>
                            <option value="SA">Paraguay</option>
                            <option value="QA">Peru</option>
                            <option value="KW">Philippines</option>
                            <option value="OM">Poland</option>
                            <option value="AE">Portugal</option>
                            <option value="SA">Qatar</option>
                            <option value="QA">Romania</option>
                            <option value="KW">Russia</option>
                            <option value="OM">Rwanda</option>
                            <option value="AE">Saint Kitts and Nevis</option>
                            <option value="SA">Saint Lucia</option>
                            <option value="QA">Saint Vincent and the Grenadines</option>
                            <option value="KW">Samoa</option>
                            <option value="OM">San Marino</option>
                            <option value="AE">Sao Tome and Principe</option>
                            <option value="SA">Saudi Arabia</option>
                            <option value="QA">Serbia</option>
                            <option value="KW">Seychelles</option>
                            <option value="OM">Sierra Leone</option>
                            <option value="AE">Singapore</option>
                            <option value="SA">Slovakia</option>
                            <option value="QA">Slovenia</option>
                            <option value="KW">Somalia</option>
                            <option value="OM">South Africa</option>
                            <option value="AE">South Korea</option>
                            <option value="SA">Spain</option>
                            <option value="QA">Sudan</option>
                            <option value="KW">Suriname</option>
                            <option value="OM">Sweden</option>
                            <option value="AE">Switzerland</option>
                            <option value="SA">Syria</option>
                            <option value="QA">Tajikistan</option>
                            <option value="KW">Tanzania</option>
                            <option value="OM">Thailand</option>
                            <option value="AE">Timor-Leste</option>
                            <option value="SA">Togo</option>
                            <option value="QA">Tonga</option>
                            <option value="KW">Trinidad and Tobago</option>
                            <option value="OM">Tunisia</option>
                            <option value="AE">Turkey</option>
                            <option value="SA">Turkmenistan</option>
                            <option value="QA">Uganda</option>
                            <option value="KW">Ukraine</option>
                            <option value="OM">United Arab Emirates</option>
                            <option value="AE">United Kingdom</option>
                            <option value="SA">United States</option>
                            <option value="QA">Uruguay</option>
                            <option value="KW">Uzbekistan</option>
                            <option value="OM">Vanuatu</option>
                            <option value="AE">Venezuela</option>
                            <option value="SA">Vietnam</option>
                            <option value="QA">Yemen</option>
                            <option value="KW">Zambia</option>
                            <option value="OM">Zimbabwe</option>
                        </select>
