<div class="flex items-center justify-center mb-2 md:mb-4">
    <div class="mt-4 md:mt-12 px-8 md:px-32 text-center">
        <h1 class="text-6xl mx-auto inline-block mb-8 md:mb-12">{{trans('components/article-all-show.page-title')}}</h1>
        @if(!$allArticles)
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($allArticles as $article)
                ...
                class="block bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
